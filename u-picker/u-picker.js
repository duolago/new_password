...
(global.webpackJsonp = global.webpackJsonp || []).push([ [ "uview-ui/components/u-picker/u-picker" ], {
    ...
    2930: function(e, i, r) {
        ...
        var s = o(r("87f4")), a = o(r("19ec")), n = o(r("0715"));
        function o(t) {
        ...
        var c = {
            ...
            watch: {
                ...
                regionChange: function(t) {
                    this.citys = a.default[this.province], this.areas = n.default[this.province][this.city];
                },
            ...
            methods: {
                ...
                getItemValue: function(e, i) {
                    if (this.mode == i) return "object" == t(e) ? e[this.rangeKey] : e;
                },
                ...
                setProvinces: function() {
                    if (this.params.province) {
                        ...
                        s.default.map(function(i, r) {
                            (e ? i.value == t : i.label == t) && (t = r);
                        }), this.province = t, this.provinces = s.default, this.valueArr.splice(0, 1, this.province);
                    }
                },
                setCitys: function() {
                    if (this.params.city) {
                        ...
                        a.default[this.province].map(function(i, r) {
                            (e ? i.value == t : i.label == t) && (t = r);
                        }), this.city = t, this.citys = a.default[this.province], this.valueArr.splice(1, 1, this.city);
                    }
                },
                setAreas: function() {
                    if (this.params.area) {
                        ...
                        n.default[this.province][this.city].map(function(i, r) {
                            (e ? i.value == t : i.label == t) && (t = r);
                        }), this.area = t, this.areas = n.default[this.province][this.city], this.valueArr.splice(2, 1, this.area);
                    }
                },
                close: function() {
                    this.$emit("input", !1);
                ...
                change: function(t) {
                    ...
                    this.params.city && (this.city = this.valueArr[e++]), this.params.area && (this.area = this.valueArr[e++]); else if ("multiSelector" == this.mode) {
                        var i = null;
                        this.defaultSelector.map(function(e, r) {
                            e != t.detail.value[r] && (i = r);
                        }), null != i && this.$emit("columnchange", {
                            column: i,
                            index: t.detail.value[i]
                        });
                    }
                },
                getResult: function() {
                    ...
                    if (!this.moving) {
                        ...
                        this.params.second && (e.second = this.formatNumber(this.second || 0)), this.params.timestamp && (e.timestamp = this.getTimestamp())) : "region" == this.mode ? (this.params.province && (e.province = s.default[this.province]), 
                        this.params.city && (e.city = a.default[this.province][this.city]), this.params.area && (e.area = n.default[this.province][this.city][this.area])) : ("selector" == this.mode || "multiSelector" == this.mode) && (e = this.valueArr), 
    ...
    "7d2c": function(t, e, i) {
        ...
        var r = {
            uPopup: function() {
                return i.e("uview-ui/components/u-popup/u-popup").then(i.bind(null, "18ce"));
            }
        }, s = function() {
            var t = this, e = (t.$createElement, t._self._c, "region" != t.mode && "time" == t.mode && !t.reset && t.params.month ? t.__map(t.months, function(e, i) {
                return {
                    $orig: t.__get_orig(e),
                    m0: t.formatNumber(e)
                };
            }) : null), i = "region" != t.mode && "time" == t.mode && !t.reset && t.params.day ? t.__map(t.days, function(e, i) {
                return {
                    $orig: t.__get_orig(e),
                    m1: t.formatNumber(e)
                };
            }) : null, r = "region" != t.mode && "time" == t.mode && !t.reset && t.params.hour ? t.__map(t.hours, function(e, i) {
                return {
                    $orig: t.__get_orig(e),
                    m2: t.formatNumber(e)
                };
            }) : null, s = "region" != t.mode && "time" == t.mode && !t.reset && t.params.minute ? t.__map(t.minutes, function(e, i) {
                return {
                    $orig: t.__get_orig(e),
                    m3: t.formatNumber(e)
                };
            }) : null, a = "region" != t.mode && "time" == t.mode && !t.reset && t.params.second ? t.__map(t.seconds, function(e, i) {
                return {
                    $orig: t.__get_orig(e),
                    m4: t.formatNumber(e)
                };
            }) : null, n = "region" == t.mode || "time" == t.mode || "selector" != t.mode || t.reset ? null : t.__map(t.range, function(e, i) {
                return {
                    $orig: t.__get_orig(e),
                    m5: t.getItemValue(e, "selector")
                };
            }), o = "region" != t.mode && "time" != t.mode && "selector" != t.mode && "multiSelector" == t.mode ? t.__map(t.range, function(e, i) {
                return {
                    $orig: t.__get_orig(e),
                    l6: t.reset ? null : t.__map(e, function(e, i) {
                        return {
                            $orig: t.__get_orig(e),
    ...
    "878a": function(t, e, i) {
        ...
        i("be59");
        var n = i("f0c5"), o = Object(n.a)(s.default, r.b, r.c, !1, null, "37f97434", null, !1, r.a, void 0);
        e.default = o.exports;
    },
    "9ee3": function(t, e, i) {},
    be59: function(t, e, i) {
    ...
    "uview-ui/components/u-picker/u-picker-create-component": function(t, e, i) {
        i("543d").createComponent(i("878a"));
    }
